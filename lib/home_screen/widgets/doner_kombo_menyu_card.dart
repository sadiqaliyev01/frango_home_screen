...
import 'package:frango_home_screen/data/local/doner_kombo_menyu_data.dart';
...
class DonerKomboMenyuCard extends StatelessWidget {
  const DonerKomboMenyuCard({super.key});

  @override
  Widget build(BuildContext context) {
    List<DonerKomboMenyuData> donerKomboMenyuData =
        DonerKomboMenyuData.getDonerKomboMenyuData;
    return Card(
      child: Column(
        children: [
          Padding(
          ...
          Padding(
            ...
            child: ListView.builder(
              itemCount: donerKomboMenyuData.length,
              shrinkWrap: true,
              physics: const NeverScrollableScrollPhysics(),
              itemBuilder: (context, index) {
                final data = donerKomboMenyuData[index];
                return Padding(
