...
import 'package:frango_home_screen/data/local/ickiler_data.dart';
...
class IckilerCard extends StatelessWidget {
  const IckilerCard({super.key});

  @override
  Widget build(BuildContext context) {
    List<IckilerData> ickilerData = IckilerData.getIckilerData;
    return Card(
      child: Column(
        children: [
          Text(
          ...
          Padding(
            ...
            child: ListView.builder(
              itemCount: ickilerData.length,
              shrinkWrap: true,
              physics: const NeverScrollableScrollPhysics(),
              itemBuilder: (context, index) {
                final data = ickilerData[index];
                return Padding(
