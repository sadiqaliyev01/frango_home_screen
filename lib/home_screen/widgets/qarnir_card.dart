...
import 'package:frango_home_screen/data/local/qarnir_data.dart';
...
class QarnirCard extends StatelessWidget {
  const QarnirCard({super.key});

  @override
  Widget build(BuildContext context) {
    List<QarnirData> qarnirData = QarnirData.getQarnirData;
    return Card(
      child: Column(
        children: [
          Padding(
          ...
          Padding(
            ...
            child: ListView.builder(
              itemCount: qarnirData.length,
              shrinkWrap: true,
              physics: const NeverScrollableScrollPhysics(),
              itemBuilder: (context, index) {
                final data = qarnirData[index];
                return Padding(
