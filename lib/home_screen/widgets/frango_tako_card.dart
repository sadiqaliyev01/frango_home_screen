...
import 'package:frango_home_screen/data/local/frango_izgara_kofte_data.dart';
...
class FrangoTakoCard extends StatelessWidget {
  const FrangoTakoCard({super.key});

  @override
  Widget build(BuildContext context) {
    List<FrangoTakoData> frangoTakoData = FrangoTakoData.getFrangoTakoData;
    return Card(
      child: Column(
        children: [
          Padding(
          ...
          Padding(
            ...
            child: ListView.builder(
              itemCount: frangoTakoData.length,
              shrinkWrap: true,
              physics: const NeverScrollableScrollPhysics(),
              itemBuilder: (context, index) {
                final data = frangoTakoData[index];
                return Padding(
